...
namespace IronTest
{
    ...
    public class MoveTest
    {
        ...
        {
            var result = (bool)"(= (get-x (move_forward '(0 8 0 0) 0)) 0)".Eval();
        ...
        {
            var result = (bool)"(= (get-x (move_forward '(0 8 0 0) 10)) 10)".Eval();
        ...
        {
            var result = (bool)"(= (get-x (move_forward '(0 9 0 0) 10)) 3)".Eval();
        ...
        {
            var result = (bool)"(= (get-x (move_forward '(5 1 0 0) 2)) 7)".Eval();
        ...
        {
            var result = (bool)"(= (get-y (move_forward '(8 3 3 0) 2)) 5)".Eval();
        ...
        {
            var result = (bool)"(= (get-y (move_forward '(7 1 3 0) 1)) 1)".Eval();
        ...
        {
            var result = (bool)"(= (get-x (move_backward '(0 8 0 0) 0)) 0)".Eval();
        ...
        {
            var result = (bool)"(= (get-x (move_backward '(0 8 2 0) 1)) 1)".Eval();
        ...
        {
            var result = (bool)"(= (get-x (move_backward '(0 8 2 0) 10)) 10)".Eval();
        ...
        {
            var result = (bool)"(= (get-x (move_backward '(0 9 2 0) 10)) 3)".Eval();
        ...
        {
            var result = (bool)"(= (get-x (move_backward '(5 1 2 0) 2)) 7)".Eval();
        ...
        {
            var result = (bool)"(= (get-y (move_backward '(8 3 1 0) 2)) 5)".Eval();
        ...
        {
            var result = (bool)"(= (get-y (move_backward '(7 1 1 0) 1)) 1)".Eval();
